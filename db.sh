...
mysql_8_4() {
    compose_down "versioned/mysql-8.4/docker-compose.yaml" "mysql"
    compose_up "versioned/mysql-8.4/docker-compose.yaml"
    mysql_post_setup
}
...
db2_spatial() {
    ...
    db2_osx_setup
    compose_up "latest/db2_spatial/docker-compose.yaml"
