...
@DomainModel(
		annotatedClasses = {
				AbstractMutationStrategyGeneratedIdWithOptimizerTest.Person.class,
				AbstractMutationStrategyGeneratedIdWithOptimizerTest.Doctor.class,
				AbstractMutationStrategyGeneratedIdWithOptimizerTest.Engineer.class
		}
)
@SessionFactory
@RequiresDialectFeature(feature = DialectFeatureChecks.SupportsIntegerSequences.class)
public abstract class AbstractMutationStrategyGeneratedIdWithOptimizerTest {
