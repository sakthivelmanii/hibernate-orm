...
@SessionFactory
@JiraKey("HHH-19314")
@SkipForDialect(dialectClass = SpannerPostgreSQLDialect.class, reason = "ON CONFLICT clause with empty conflict target in INSERT statement is not supported in Emulator")
