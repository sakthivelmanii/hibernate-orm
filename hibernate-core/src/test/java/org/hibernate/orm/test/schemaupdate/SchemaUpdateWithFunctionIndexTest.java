...
@SessionFactory
@SkipForDialect(dialectClass = SpannerPostgreSQLDialect.class, reason = "Spanner doesn't support dropping table without dropping indexes. "
																		+ "Spanner doesn't support creating tables without primary key")
